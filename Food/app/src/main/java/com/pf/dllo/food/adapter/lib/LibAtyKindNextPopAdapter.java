 ...
 */
public class LibAtyKindNextPopAdapter extends RecyclerView.Adapter<LibAtyKindNextPopAdapter.LibAtyKindVH>{
    private List<LibAtyBean.FoodsBean> datas;
    private Context mContext;

    public LibAtyKindNextPopAdapter(Context context) {
        mContext = context;
        datas = new ArrayList<>();
    }
