 ...
 */
public class LibAtyKindSearchNextPopAdapter extends RecyclerView.Adapter<LibAtyKindSearchNextPopAdapter.LibAtyKindVH>{
    private List<LibKindBean.ItemsBean> datas;
    private Context mContext;

    public LibAtyKindSearchNextPopAdapter(Context context) {
        mContext = context;
        datas = new ArrayList<>();
    }

    public List<LibKindBean.ItemsBean> getDatas() {
        return datas;
    }

    public void setDatas(List<LibKindBean.ItemsBean> datas) {
        this.datas = datas;
